...
class DataTransformation:
    ...
    def initate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            input_feature_train_df = train_df.drop(columns=['depth','table','price','x (Premium)','z (Very Good)','y (Good)'],axis=1)
            target_feature_train_df=train_df['price']
            logging.info(target_feature_train_df)

            input_feature_test_df=test_df.drop(columns=['depth','table','price','x (Premium)','z (Very Good)','y (Good)'],axis=1)
